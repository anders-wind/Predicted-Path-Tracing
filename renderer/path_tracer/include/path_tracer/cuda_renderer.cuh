 ...
 * TODO move kernels to their own file path_tracer_kernels.cuh.
 *
 */
...
class cuda_renderer
{
    ...
    path_tracer::render_datapoint ray_trace_datapoint()
    {
        const auto timer = shared::scoped_timer("ray_trace_datapoint");
        auto ray_traced_image = render(w, h);
    ...
    path_tracer::render_datapoint ray_trace_datapoint(render& ray_traced_image)
    {
