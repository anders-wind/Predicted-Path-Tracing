...
__device__ void box_bubble_sort(hitable** arr, int n, int index)
{
    int i, j;
...
__device__ void box_x_bubble_sort(hitable** arr, int n)
{
    box_bubble_sort(arr, n, 0);
}
__device__ void box_y_bubble_sort(hitable** arr, int n)
{
    box_bubble_sort(arr, n, 1);
}
__device__ void box_z_bubble_sort(hitable** arr, int n)
{
